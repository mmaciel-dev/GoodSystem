...
let requirements = [
    {
        ...
        userStory: 'Como desenvolvedor, eu quero implementar autenticação OAuth 2.0, para que os usuários possam fazer login de forma segura usando suas contas existentes.',
        type: 'functional',
        status: 'approved',
        priority: 'high',
        sprint: 'sprint-12',
    ...
    },
    {
        ...
        userStory: 'Como gestor de projeto, eu quero visualizar métricas em um dashboard interativo, para que eu possa acompanhar o progresso dos requisitos em tempo real.',
        type: 'functional',
        status: 'pending',
        priority: 'high',
        sprint: 'sprint-12',
    ...
    },
    {
        ...
        userStory: 'Como desenvolvedor front-end, eu quero uma API RESTful bem documentada, para que eu possa integrar facilmente as funcionalidades no sistema.',
        type: 'technical',
        status: 'approved',
        priority: 'high',
        sprint: 'sprint-12',
    ...
    },
    {
        ...
        userStory: 'Como usuário do sistema, eu quero receber notificações em tempo real, para que eu seja informado imediatamente sobre mudanças importantes.',
        type: 'functional',
        status: 'draft',
        priority: 'medium',
        sprint: 'sprint-13',
    ...
    },
    {
        ...
        userStory: 'Como gerente de projeto, eu quero exportar relatórios em PDF e Excel, para que eu possa compartilhar informações com stakeholders externos.',
        type: 'functional',
        status: 'pending',
        priority: 'medium',
        sprint: 'sprint-13',
    ...
    },
    {
        ...
        userStory: 'Como usuário mobile, eu quero acessar o sistema pelo celular com a mesma qualidade, para que eu possa gerenciar requisitos em qualquer lugar.',
        type: 'non-functional',
        status: 'approved',
        priority: 'high',
        sprint: 'sprint-12',
    ...
    },
    {
        ...
        userStory: 'Como analista de requisitos, eu quero visualizar o histórico de mudanças, para que eu possa entender a evolução de cada requisito.',
        type: 'functional',
        status: 'rejected',
        priority: 'low',
        sprint: null,
    ...
    },
    {
        ...
        userStory: 'Como tech lead, eu quero integração com Jira e GitHub, para que nossos requisitos estejam sincronizados com as ferramentas de desenvolvimento.',
        type: 'technical',
        status: 'draft',
        priority: 'medium',
        sprint: 'sprint-13',
    ...
    },
    {
        ...
        userStory: 'Como colaborador, eu quero comentar e mencionar outros usuários, para que possamos discutir requisitos de forma eficiente.',
        type: 'functional',
        status: 'pending',
        priority: 'medium',
        sprint: 'sprint-12',
    ...
    },
    {
        ...
        userStory: 'Como usuário do sistema, eu quero que as páginas carreguem rapidamente, para que eu possa trabalhar de forma produtiva.',
        type: 'non-functional',
        status: 'approved',
        priority: 'high',
        sprint: 'sprint-12',
    ...
    },
    {
        ...
        userStory: 'Como QA engineer, eu quero testes E2E automatizados, para que possamos garantir a qualidade do sistema em cada release.',
        type: 'technical',
        status: 'pending',
        priority: 'medium',
        sprint: 'sprint-13',
    ...
    },
    {
        ...
        userStory: 'Como usuário, eu quero escolher entre tema claro e escuro, para que eu possa usar o sistema confortavelmente em diferentes ambientes.',
        type: 'functional',
        status: 'draft',
        priority: 'low',
        sprint: 'sprint-14',
    ...
    },
    {
        ...
        userStory: 'Como administrador, eu quero logs detalhados de todas as ações, para que eu possa auditar e investigar incidentes.',
        type: 'non-functional',
        status: 'approved',
        priority: 'high',
        sprint: 'sprint-12',
    ...
    },
    {
        ...
        userStory: 'Como usuário avançado, eu quero buscar requisitos com filtros complexos, para que eu possa encontrar informações específicas rapidamente.',
        type: 'functional',
        status: 'pending',
        priority: 'medium',
        sprint: 'sprint-13',
    ...
    },
    {
        ...
        userStory: 'Como desenvolvedor que integra com a API, eu quero documentação interativa, para que eu possa testar endpoints e entender rapidamente como usá-los.',
        type: 'technical',
        status: 'approved',
        priority: 'medium',
        sprint: 'sprint-12',
